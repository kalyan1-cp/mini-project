...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Encrypt Key Details </span></h2>
            <h2></h2>
            <table width="627" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
              <tr>
                <td width="50" height="31"><div align="center" class="style22"> ID </div></td>
                <td width="98"><div align="center" class="style22">Owner Name </div></td>
                <td width="104"><div align="center" class="style22">File Name </div></td>
                <td width="177"><div align="center" class="style22">Encrypt Key </div></td>
                <td width="184"><div align="center" class="style22">Date &amp; Time</div></td>
              </tr>
              <%
      	...
      	try 
	{
      		...
      		String query="select * from encryptkey "; 
