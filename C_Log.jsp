...
try 
	{		
				...
				if ( rs.next() )
				{
					...
					String query1="Select *from audit_log where fname='"+fname+"' and owner='"+s6+"' and audit_status='Not Safe'"; 
				...
				if ( rs1.next() )
				{
						...
						%>
							<h2 class="style30">File Log Already Sent to <%=s6%> !</h2>
				...
				Statement st1=connection.createStatement();
							st1.executeUpdate("insert into  audit_log(fname,owner,trapdoor,audit_status) values ('"+s2+"','"+s6+"','"+s3+"','Not Safe')");
	%>
							<h2 class="style30">File Log Sent Sucessfully to <%=s6%> !</h2>
							<a href="C_AuditData.jsp">Back</a><br />
							<%
