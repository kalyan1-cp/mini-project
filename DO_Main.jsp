      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="DO_Uplo.jsp">Upload</a></li>
            <li><a href="DO_Update.jsp">Update</a></li>
            <li><a href="DO_Delete.jsp">Delete</a></li>
            <li><a href="DO_ViewFiles.jsp">View Files </a></li>
            <li><a href="DO_SecPer.jsp">Secret Key Permission </a></li>
            <li><a href="DO_DeduplicationFiles.jsp">View Deduplication Files </a></li>
            <li><a href="DO_Login.jsp">Logout</a></li>
          </ul>
        </div>
        <div class="gadget">
