...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Encryption Key Request </span></h2>
          <p>&nbsp;</p>
          <h5><span class="style17">Click Here</span><a href="DO_EncKey.jsp" class="style17"> To Request for Encrypt Key Permission </a></h5>
