...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span> Decrypt Key  </span>Response</h2>
            <h2></h2>
            <p></p>
            <form id="form" name="form1" method="post" action="EU_DeckRes1.jsp">
              <div align="center" class="style4">
                ...
                <p><br />
                  <br />
                  <input type="submit" name="Submit" value="View Decrypt Key Response" />
                                </p>
                <p align="right"><a href="EU_DecryptKey.jsp">Back</a> </p>
              </div>
            </form>
            <%String key=(String)application.getAttribute("key");
			  if(key!=(null))
			  {%>
            <p align="center" class="style4"><strong> Decrypt Key  : <%=key%>&nbsp;</strong></p>
