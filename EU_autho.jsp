...
<div class="main">
  <div class="menu_nav">
    <div class="menu_nav_resize">
      <ul>
            <li class="active"><a href="EU_autho.jsp">End User </a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <h3>&nbsp;</h3>
          <p>&nbsp;</p>
          <h3>You Are <span class="style4">Not Authorized..</span> Please Wait For Authorization !! </h3>
          <p>&nbsp;</p>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="EU_autho.jsp">Home</a></li>
            <li><a href="EU_Login.jsp">Logout</a></li>
          </ul>
        </div>
