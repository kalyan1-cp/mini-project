        ...
        <div class="article">
          ...
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              ...
              <td width="183"><div align="center" class="style21"><span class="style23">Data Owner  Name </span></div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td><div align="center"><a href="C_OwnerDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
              <%	
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="C_AuthoUser.jsp">Authorize End Users </a></li>
            <li><a href="C_Login.jsp">Logout</a></li>
          </ul>
        </div>
        <div class="gadget">
