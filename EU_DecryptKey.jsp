...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Decrypt Key  </span></h2>
            <h2></h2>
            <h3 align="justify"><span class="style4"><span class="style5"><span class="style6"><span class="style5"><span class="style7">Click To <a href="EU_ReqDeck.jsp">Request Decrypt Key .</a></span></span></span></span></span></h3>
            <h3 align="justify"><span class="style7">Click To <a href="EU_DeckRes.jsp">View Decrypt Key Response .</a></span></h3>
            <p></p>
