...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>File Content Attack Details</span></h2>
            <h2></h2>
            <table width="622" border="2" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td width="57" height="31"><div align="center" class="style22"> ID </div></td>
                <td width="107"><div align="center" class="style22">File Name </div></td>
                <td width="283"><div align="center" class="style22">Digital Sign Generated </div></td>
                <td width="163"><div align="center" class="style22">Date &amp; Time</div></td>
              </tr>
              <%
