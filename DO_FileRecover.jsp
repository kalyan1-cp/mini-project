...
try 
	{				
				...
				String query1="Select *from ownerfiles where downer='"+dname+"' and fname='"+fname+"' "; 
				...
				while ( rs1.next() )
				{
					...
					Statement st=connection.createStatement();
							st.executeUpdate("update cloudserver set ct='"+s7+"',trapdoor='"+s8+"' where downer='"+dname+"' and fname='"+fname+"' ");
							
					st.executeUpdate("update audit_log set audit_status='Recovered' where owner='"+dname+"' and fname='"+fname+"' ");

	%>
							<h2 class="style30">File Recovered Sucessfully !</h2>
							<a href="DO_ViewFiles.jsp">Back</a><br />
							<%
