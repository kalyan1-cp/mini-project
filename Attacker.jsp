      ...
      <div class="mainbar">
        <div class="article">
          <h2><span>Attacker</span></h2>
            <h2></h2>
            <form id="form1" method="post" action="Attacker1.jsp">
              <label> </label>
              <table width="553" border="0" align="center">
                <tr>
                  <td width="145"><span class="style3">Enter File name: </span></td>
                  <td width="398"><input required="required" name="tt22" type="text" id="tt2" size="30"/></td>
                </tr>
              </table>
              <label>
              </br>
              ...
              <p align="center">
                <input align="right" type="submit" name="Submit22" value="View File Content" />
              </p>
            </form>
            <p>&nbsp;</p>
