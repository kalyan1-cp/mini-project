...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Attackers</span></h2>
            <h2></h2>
            <table width="622" border="2" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td width="60" height="31"><div align="center" class="style22"> ID </div></td>
                <td width="111"><div align="center" class="style22"> Name </div></td>
                <td width="132"><div align="center" class="style22">File Name </div></td>
                <td width="258"><div align="center" class="style22">Missmatch Key </div></td>
                <td width="193"><div align="center" class="style22">Date &amp; Time</div></td>
              </tr>
              <%
