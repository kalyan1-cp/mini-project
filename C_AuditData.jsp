...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Audit Data </span></h2>
            <p><strong><em>Shared Files Are Not Audited </em></strong></p>
...
try 
	{		
				...
				%>
              <tr>
                <td width="61" height="30"><div align="center" class="style21"><span class="style23"> ID </span></div></td>
                <td width="111"><div align="center" class="style21"><span class="style23">File Name </span></div></td>
                <td width="124"><div align="center" class="style21"><span class="style23">Data Owner </span></div></td>
                <td width="145"><div align="center" class="style21"><span class="style23">Date &amp; Time </span></div></td>
                <td width="125"><div align="center" class="style21"><span class="style23">View </span></div></td>
              </tr>
              <%
				
				
				String query="Select *from cloudserver where trapdoor!='Shared' "; 
              ...
              <tr>
                ...
                <td><div align="center"><a href="C_AuditData1.jsp?fname=<%=s2%>"><input name="" type="button" value="Audit File .." />
                </a></div></td>
            </tr>
              <%
				}
